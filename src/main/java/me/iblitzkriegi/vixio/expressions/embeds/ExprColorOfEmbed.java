 ...
 */
@ExprAnnotation.Expression(returntype = String.class, type = ExpressionType.SIMPLE, syntax = "color of embed %string%")
public class ExprColorOfEmbed extends SimpleExpression<String>{
    ...
    private String getEmbed(Event e){
        ...
        if(embed.getColor()!=null){
            return embed.getColor().toString();
        }
        return "<none>";
    }
}
