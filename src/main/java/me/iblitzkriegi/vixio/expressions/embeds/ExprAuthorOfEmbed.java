 ...
 */
@ExprAnnotation.Expression(returntype = String.class, type = ExpressionType.SIMPLE, syntax = "author of embed %string%")
public class ExprAuthorOfEmbed extends SimpleExpression<String>{
    ...
    private String getEmbed(Event e){
        ...
        if(embed.getAuthor()!=null){
            return String.valueOf(embed.getAuthor());
        }
        return "<none>";
    }
}
