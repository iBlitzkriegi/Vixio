...
public class ExprFieldsOfEmbed extends SimpleExpression<MessageEmbed.Field> {

    static {
        Vixio.getInstance().registerPropertyExpression(ExprFieldsOfEmbed.class, MessageEmbed.Field.class, "field[s]", "embedbuilders")
