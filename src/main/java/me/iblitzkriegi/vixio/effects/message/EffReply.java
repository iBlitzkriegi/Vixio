...
import me.iblitzkriegi.vixio.events.message.EvntGuildMessageReceive;
import me.iblitzkriegi.vixio.events.message.EvntPrivateMessageReceive;
...
public class EffReply extends Effect{
    ...
    protected void execute(Event e) {
        if(e instanceof EvntGuildMessageReceive) {
            ...
            if(message.getSingle(e)!=null) {
                ...
                Skript.warning("You must include a message to send!");
            }
    ...
    public boolean init(Expression<?>[] expr, int i, Kleenean kleenean, SkriptParser.ParseResult parseResult) {
        ...
        Skript.warning("You may not use \"reply with\" out of Vixio messaging events!");
        return false;
    }
}
