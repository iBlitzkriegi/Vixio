...
@CondAnnotation.Condition(
        name = "MessageHasMoreThanMentioned",
        title = "Message has more than Mentioned users",
        desc = "Check if a message has more than a certain amount of mentions",
        syntax = "size of mentioned users in message %message% is more than %number%",
...
public class CondMoreThan extends Condition{
