    ...
    private String getNickname(Event e){
        for(Map.Entry<String, JDA> jdaEntry : bots.entrySet()){
            if(jdaEntry.getValue().getGuildById(vGuild.getSingle(e))!=null){
                ...
                if(guild.getUserById(vID.getSingle(e))!=null){
                    if(guild.getNicknameForUser(guild.getUserById(vID.getSingle(e)))!=null){
                        return guild.getNicknameForUser(guild.getUserById(vID.getSingle(e)));
                    }else{
                        return "null";
                    }
                }else{
