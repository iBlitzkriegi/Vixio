 ...
 */
public class ExprRegionOfGuild extends SimpleExpression<String> {
    private Expression<String> id;
    @Override
    protected String[] get(Event e) {
        return new String[]{getGuildRegion(e)};
    }
    ...
    public String getGuildRegion(Event e){
        Guild s = API.getAPI().getJDA().getGuildById(id.getSingle(e));
        return s.getRegion().getName();
    }
}
